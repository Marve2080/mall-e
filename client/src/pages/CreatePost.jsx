...
function CreatePost() {
    ...
    const generateImage = async () => {
        if(form.prompt){
            try{
                ...
                const response = await fetch("https://mall-e.onrender.com/api/v1/dalle", {
                    method: 'POST',
                    headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        if(form.prompt && form.photo) {
            ...
            try {
                const response = await fetch("https://mall-e.onrender.com/api/v1/post", 
                    {
                        method: "POST",
                        headers: {
                            'Content-Type' : "application/json",
    ...
    <section className="max-w-7xl mx-auto">
        <div>
            ...
            <p className='mt-2 text-[#666e75] text-[16px] max-w [500px]'>
                Create imaginative and visually stunning images through MALLE AI and share them with the community
            </p>
        </div>
